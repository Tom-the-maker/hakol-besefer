...
export const TermsOfService: React.FC<LegalPageProps> = ({ onBack }) => (
  <LegalShell onBack={onBack} title="תנאי שימוש">
    ...
    <p>
      ברוכים הבאים לסוףסיפור ("השירות"). השירות מאפשר יצירת ספרים מאוירים מותאמים אישית באמצעות בינה מלאכותית.
      השימוש בשירות מהווה הסכמה לתנאים אלה.
    </p>

    <LegalH2>2. השירות</LegalH2>
    <p>
      סוףסיפור משתמש בטכנולוגיית AI חיצונית ליצירת טקסט ואיורים. התוצאות נוצרות באופן אוטומטי ועשויות להשתנות.
    ...
    <p>
      ...
      הטכנולוגיה, העיצוב והמותג שייכים לסוףסיפור.
    </p>
...
export const AccessibilityStatement: React.FC<LegalPageProps> = ({ onBack }) => (
  <LegalShell onBack={onBack} title="הצהרת נגישות">
    ...
    <p>
      סוףסיפור מחויבת להנגיש את האתר והשירותים שלה לכלל האוכלוסייה, לרבות אנשים עם מוגבלות,
...
export const CancellationPolicy: React.FC<LegalPageProps> = ({ onBack }) => (
  <LegalShell onBack={onBack} title="מדיניות ביטולים והחזרים">
    ...
    <LegalH2>1. כללי</LegalH2>
    <p>
      מדיניות זו חלה על כל רכישה באתר סוףסיפור ומתבססת על חוק הגנת הצרכן, התשמ"א-1981,
