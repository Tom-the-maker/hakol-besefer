...
const BookSalesPageOptionC: React.FC<BookSalesPageOptionProps> = ({ story, inputs, onUnlock, onSave }) => {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_15%_15%,#f6c85b33_0%,transparent_42%),radial-gradient(circle_at_80%_4%,#3c70b226_0%,transparent_34%),#fff]" dir="rtl">
      <div className="max-w-[1300px] mx-auto px-4 md:px-8 pt-24 pb-10">
        ...
        <section ref={salesRef} className="mt-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-stretch">
            <article className={`w-full h-full rounded-[30px] p-6 md:p-8 border-2 bg-white transition-all flex flex-col ${isPulsing ? 'border-[#f6c85b] ring-4 ring-[#f6c85b]/30' : 'border-[#f6c85b]'}`}>
            ...
            <article className="w-full h-full rounded-[30px] p-6 md:p-8 border border-gray-200 bg-white flex flex-col">
              <div className="flex items-end justify-between gap-3 mb-4">
                <div>
